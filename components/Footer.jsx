  ...
  return (
    ...
    <div className='text-center sm:flex items-center justify-around border-t border-gray-400 mx-[10%] mt-12 py-6'>
        ...
        <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
            <li><a target='_blank' href="https://github.com/sanjanach10">GitHub</a></li>
            <li><a target='_blank' href="https://linkedin.com/in/sanjanac1001">LinkedIn</a></li>
